...
int main()
{
	...
	int nx = 25, ny = 3001, nz = 25, tnpts = 20001, sim_tnpts = 0, vcast_variation_tnpts = 10001;
	...
	while (SteelTemperature3dplant.tstep < tnpts && SteelTemperature3dplant.tstep > sim_tnpts)
	{
		...
		{
			Gradientmethod.computejacobian(SteelTemperature3dplant, predictstep, h_init, dh);
